                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-5">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-body">
                                        <form class="user-select-auto" action="../../SvLogin" method="POST">
                                            <div class="form-floating mb-3">
                                                <input class="form-control" id="inputUsuario" type="text" name="usuario" placeholder="nombre de usuario" />
                                    ...
                                    <div class="card-footer text-center py-3">
                                        <div class="small"><a href="altaEmpleado.jsp">¿Necesita una cuenta? ¡Registrarse!</a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
