                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-7">
                                <div class="card shadow-lg border-0 rounded-lg mt-3 mb-3">
                                    <div class="card-header"><h3 class="text-center font-weight-light my-4">Alta Cliente</h3></div>
                                    <div class="card-body">
                                        <form action="../../SvCliente" method="POST">
                                            ...
                                            <div class="mt-4 mb-0">
                                                <div class="d-grid"><button class="btn btn-primary btn-block" type="submit">Crear Cliente</button></div>
                                            </div>
                                        </form>
                                    </div>
