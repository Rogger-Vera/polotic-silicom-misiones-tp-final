                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-12">
                                <div class="card shadow-lg border-0 rounded-lg mt-3 mb-3">
                                    <div class="card-header"><h3 class="text-center font-weight-light my-4">Clientes</h3></div>
                                    <div class="card-body">
                                            ...
                                            <div class="card-body">
                                                ...
                                                %>  
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><%=control.deDateAString(cli.getFechaNac())%></td>
                                                            <td><%=cli.getNacionalidad()%></td>
                                                            <td><%=cli.getCelular()%></td>
                                                            <td><%=cli.getEmail()%></td>
                                                            
                                                            <td>
                                                                <form name="formModificarPersona" action="../../SvModificararCliente" method="POST">
                                                            ...
                                                            <td>
                                                                <form name="formBorrarPersona" action="../../SvEliminarCliente" method="POST">
                                                                    <input type="hidden" name="id" value="<%=cli.getId()%>">
