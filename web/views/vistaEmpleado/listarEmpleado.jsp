                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-12">
                                <div class="card shadow-lg border-0 rounded-lg mt-3 mb-3">
                                    <div class="card-header"><h3 class="text-center font-weight-light my-4">Empleados</h3></div>
                                    <div class="card-body">
                                            ...
                                            <div class="card-body">
                                                ...
                                                %>  
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><%=control.deDateAString(emp.getFechaNac())%></td>
                                                            ...
                                                            <td>
                                                                <form name="formBorrarEmpleado" action="../../SvEliminarEmpleado" method="POST">
                                                                    <input type="hidden" name="id" value="<%=emp.getId()%>">
                                                                    <input type="hidden" name="idUsu" value="<%=user.getId()%>">
