...
@WebServlet(name = "SvModDatosCliente", urlPatterns = {"/SvModDatosCliente"})
public class SvModDatosCliente extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        cliente.setFechaNac(control.deStringADate(fechaNac));
